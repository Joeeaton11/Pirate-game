...
| 2026-08-21 | `assets/brand/tileset-catalog/terrain_extras_3_sheet_v1.png` | `TERRAIN_EXTRAS_3_MANIFEST.md` | 309 | `tiles/` (ground, paths, paving, transitions, beach, elevation, bridges, water), `nature/` (trees, rocks, vegetation), `props/`, `decals/`, `water_fx/`, `harbour/`, `buildings/` (new `floor_tile_*`), `weather_fx/` (first entries — previously empty) | **No** — cut and filed only, not yet wired into any renderer. Re-cut 2026-08-21 after an independent `asset-qa` pass found baked-in caption text, wrong category boundaries, and a miscounted Panel 13/22 structure in the original 2026-08-20 pass (306→309 items after correction) — see `TERRAIN_EXTRAS_3_MANIFEST.md`'s intro and `GAME_DESIGN.md` item 145 |
