...
const BACKDROP_THEME: Record<BattleBackdrop, BackdropTheme> = {
  town: {
    ...
    decorations: [
      { emoji: '🏠', size: 32, opacity: 0.55, top: 6, left: 8 },
      { emoji: '⛪', size: 36, opacity: 0.5, top: 0, left: '40%' },
      { emoji: '🏚️', size: 30, opacity: 0.5, top: 8, right: 10 },
      { emoji: '🏠', size: 26, opacity: 0.4, top: '38%', left: '8%' },
      { emoji: '🍺', size: 20, opacity: 0.35, top: '46%', right: '38%' },
      { emoji: '🕯️', size: 18, opacity: 0.4, bottom: '18%', left: '30%' },
      { emoji: '🛢️', size: 22, opacity: 0.35, bottom: '14%', right: '22%' },
    ],
  },
  jungle: {
    ...
    decorations: [
      { emoji: '🌴', size: 36, opacity: 0.6, top: 4, left: 6 },
      { emoji: '🌳', size: 44, opacity: 0.55, top: -4, left: '36%' },
      { emoji: '🌳', size: 34, opacity: 0.55, top: 6, right: 8 },
      { emoji: '🌿', size: 24, opacity: 0.4, top: '40%', left: '10%' },
      { emoji: '🍃', size: 20, opacity: 0.4, top: '50%', right: '14%' },
      { emoji: '🌴', size: 26, opacity: 0.35, bottom: '16%', left: '26%' },
      { emoji: '🦜', size: 18, opacity: 0.4, bottom: '20%', right: '30%' },
    ],
  },
  beach: {
    ...
    decorations: [
      { emoji: '🌴', size: 42, opacity: 0.7, top: 0, left: 6 },
      { emoji: '☁️', size: 26, opacity: 0.5, top: '8%', right: '18%' },
      { emoji: '🌊', size: 26, opacity: 0.4, top: '38%', left: '30%' },
      { emoji: '🐚', size: 20, opacity: 0.55, bottom: '18%', right: '26%' },
      { emoji: '🌴', size: 30, opacity: 0.5, bottom: '10%', right: 6 },
      { emoji: '⭐', size: 16, opacity: 0.4, top: '20%', left: '18%' },
    ],
  },
  sea: {
    ...
    decorations: [
      { emoji: '🌊', size: 24, opacity: 0.4, top: '10%', left: '26%' },
      { emoji: '⛵', size: 28, opacity: 0.4, top: 6, right: 14 },
      { emoji: '🌊', size: 20, opacity: 0.3, top: '42%', right: '30%' },
      { emoji: '☁️', size: 24, opacity: 0.3, top: '6%', left: '10%' },
      { emoji: '🐟', size: 16, opacity: 0.3, bottom: '18%', left: '20%' },
    ],
  },
  fort: {
    ...
    decorations: [
      { emoji: '🏰', size: 44, opacity: 0.5, top: -6, left: '34%' },
      { emoji: '💣', size: 22, opacity: 0.55, top: 8, left: 4 },
      { emoji: '💣', size: 22, opacity: 0.55, top: 8, right: 4 },
      { emoji: '🚩', size: 22, opacity: 0.45, top: '36%', left: '14%' },
      { emoji: '⚔️', size: 20, opacity: 0.4, top: '48%', right: '18%' },
      { emoji: '🪨', size: 24, opacity: 0.35, bottom: '14%', left: '24%' },
    ],
  },
  jail: {
    ...
    decorations: [
      { emoji: '🔥', size: 24, opacity: 0.75, top: 8, left: 10 },
      { emoji: '🔥', size: 24, opacity: 0.75, top: 8, right: 10 },
      { emoji: '⛓️', size: 28, opacity: 0.5, bottom: '38%', left: '46%' },
      { emoji: '🕸️', size: 22, opacity: 0.35, top: '34%', left: '12%' },
      { emoji: '🐀', size: 16, opacity: 0.4, bottom: '14%', right: '22%' },
    ],
    bars: true,
  },
};
...
const styles = StyleSheet.create({
  ...
  combatant: { gap: 5 },
  combatantFoe: { alignSelf: 'flex-end', alignItems: 'flex-end', width: '68%', marginBottom: 14 },
  ...
  actions: { paddingHorizontal: 12, paddingTop: 12, paddingBottom: 40 },
