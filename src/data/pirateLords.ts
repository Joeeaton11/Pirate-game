...
export const PIRATE_LORDS: PirateLord[] = [
  ...
  },
  {
    ...
    level: 25,
    badgeName: "Legend's Marque",
    introDialogue:
      "The Council sent you? Then you're the real thing after all. Every legend needs an ending — let's see if this is mine, or yours.",
    defeatDialogue:
    ...
    template: {
      ...
      flavor: "A legend who's supposedly died at least once already — nobody agrees on the details, only that he's still here.",
    },
  },
];
