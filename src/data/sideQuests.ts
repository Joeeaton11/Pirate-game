...
export const SIDE_QUESTS: SideQuest[] = [
  ...
  {
    id: 'patron_tortuga_customs',
    type: 'fetch',
    islandId: 'tortuga_cove',
    hostedByBuildingId: 'tortuga_customs',
    title: 'A Quiet Word with the Clerk',
    npcName: 'Clerk Osgood',
    npcEmoji: '🖋️',
    introDialogue:
      "Word is a certain shipment needs to clear inspection quietly. Forged Papers would do the trick, and there's coin in it for the captain who brings them.",
    acceptedDialogue: "Still need those papers, captain. The inspector's patience isn't infinite.",
    completeDialogue: "Beautifully done. The shipment clears tomorrow, no questions asked, no names written down.",
    goldReward: 25,
    fetchItemId: 'forged_papers',
    fetchCount: 1,
  },
  {
    id: 'patron_tortuga_smithy',
    type: 'specialty_gate',
    islandId: 'tortuga_cove',
    hostedByBuildingId: 'tortuga_smithy',
    title: 'Proving the Barrel',
    npcName: 'Young Pell',
    npcEmoji: '👦',
    introDialogue:
      "Cast a new cannon barrel and I need someone who actually knows gunnery to test it before I trust my name to it. Bring a Cannon-type aboard and let's see if it holds.",
    acceptedDialogue: "Still no gunner at your side, captain. I'm not firing that thing myself.",
    completeDialogue: "Didn't burst! You've no idea how much of my reputation just rode on that. Here — you earned this.",
    goldReward: 30,
    requiredSpecialty: 'cannon',
  },
  {
